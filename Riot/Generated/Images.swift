...
internal enum Asset {
  internal enum Images {
    ...
    internal static let dialer = ImageAsset(name: "dialer")
    internal static let didcall = ImageAsset(name: "didcall")
    internal static let inviteFriends1 = ImageAsset(name: "invite-friends1")
    internal static let launchScreenLogo = ImageAsset(name: "launch_screen_logo")
    internal static let logout = ImageAsset(name: "logout")
    internal static let paidCall = ImageAsset(name: "paid-call")
    internal static let privacy = ImageAsset(name: "privacy")
    internal static let recentCall = ImageAsset(name: "recent-call")
    internal static let sendSms = ImageAsset(name: "send-sms")
    internal static let simcall = ImageAsset(name: "simcall")
    internal static let sms = ImageAsset(name: "sms")
    internal static let tabCall = ImageAsset(name: "tab_call")
    internal static let tabCallSelected = ImageAsset(name: "tab_call_selected")
    internal static let tabChat = ImageAsset(name: "tab_chat")
    internal static let tabChatSelected = ImageAsset(name: "tab_chat_selected")
    internal static let tabContact = ImageAsset(name: "tab_contact")
    ...
    internal static let tabSetting = ImageAsset(name: "tab_setting")
    internal static let tabSettingSelected = ImageAsset(name: "tab_setting_selected")
    internal static let videocall = ImageAsset(name: "videocall")
    internal static let voipcall = ImageAsset(name: "voipcall")
    internal static let voipcalla = ImageAsset(name: "voipcalla")
    internal static let why = ImageAsset(name: "why")
  }
