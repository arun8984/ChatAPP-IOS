...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MatrixKit/MatrixKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MatrixSDK.common-JingleCallStack/MatrixSDK.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DTCoreText.default-Extension/DTCoreText.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MatrixKit-AppExtension/MatrixKit.framework"
fi
